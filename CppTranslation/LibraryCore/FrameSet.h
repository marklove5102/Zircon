...
namespace Library
{
    ...
    class FrameSet
    {
        public static std::unordered_map<MirAnimation, Frame> Players;

        public static std::unordered_map<MirAnimation, Frame> DefaultItem;

        public static std::unordered_map<MirAnimation, Frame> DefaultNPC;

        public static std::unordered_map<MirAnimation, Frame> DefaultMonster;


        public static std::unordered_map<MirAnimation, Frame>
        ...
        static FrameSet()
        {
            Players = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            /*
            Assassin = new std::unordered_map<MirAction, Frame>
            {
            ...
            DefaultItem = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 1, 0, TimeSpan.FromMilliseconds(1000)),
};

            DefaultNPC = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 4, 0, TimeSpan.FromMilliseconds(1000)),
};

            DefaultMonster = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 4, 10, TimeSpan.FromMilliseconds(500)),
                [MirAnimation.Walking] = new Frame(80, 6, 10, TimeSpan.FromMilliseconds(100)),
            ...
            ForestYeti = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            ChestnutTree = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            CarnivorousPlant = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            DevouringGhost = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Show] = new Frame(400, 10, 10, TimeSpan.FromMilliseconds(100)),
};

            Larva = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(80, 6, 10, TimeSpan.FromMilliseconds(500)),
};

            ZumaGuardian = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Show] = new Frame(640, 6, 10, TimeSpan.FromMilliseconds(100)),
};

            ZumaKing = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            Monkey = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Combat2] = new Frame(400, 6, 10, TimeSpan.FromMilliseconds(100)),
};

            NetherWorldGate = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 10, 0, TimeSpan.FromMilliseconds(200)),
};

            CursedCactus = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            NumaMage = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Combat3] = new Frame(480, 6, 10, TimeSpan.FromMilliseconds(100)),
};

            WestDesertLizard = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Combat2] = new Frame(480, 6, 10, TimeSpan.FromMilliseconds(100)),
};

            BanyaGuard = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Combat2] = new Frame(400, 6, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Combat3] = new Frame(400, 6, 10, TimeSpan.FromMilliseconds(100)),
};

            JinchonDevil = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            EmperorSaWoo = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Combat2] = new Frame(480, 6, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Combat3] = new Frame(480, 6, 10, TimeSpan.FromMilliseconds(100)),
};

            ArchLichTaeda = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Combat2] = new Frame(400, 6, 10, TimeSpan.FromMilliseconds(100)),
            ...
            PachonTheChaosBringer = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            IcySpiritGeneral = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Combat3] = new Frame(400, 6, 10, TimeSpan.FromMilliseconds(100)),
};

            FieryDancer = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            EmeraldDancer = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 10, 10, TimeSpan.FromMilliseconds(500)),
                [MirAnimation.Walking] = new Frame(80, 10, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Pushed] = new Frame(80, 10, 10, TimeSpan.FromMilliseconds(50)) { Reversed = true, StaticSpeed = true },
            ...
            QueenOfDawn = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            OYoungBeast = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            YumgonWitch = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 10, 10, TimeSpan.FromMilliseconds(500)),
                [MirAnimation.Walking] = new Frame(80, 10, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Pushed] = new Frame(80, 10, 10, TimeSpan.FromMilliseconds(50)) { Reversed = true, StaticSpeed = true },
            ...
            JinhwanSpirit = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Combat2] = new Frame(400, 10, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Combat3] = new Frame(400, 10, 10, TimeSpan.FromMilliseconds(100)),
};

            ChiwooGeneral = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 10, 10, TimeSpan.FromMilliseconds(500)),
            ...
            DragonQueen = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 10, 10, TimeSpan.FromMilliseconds(500)),
                [MirAnimation.Walking] = new Frame(80, 10, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Pushed] = new Frame(80, 10, 10, TimeSpan.FromMilliseconds(50)) { Reversed = true, StaticSpeed = true },
            ...
            DragonLord = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 10, 10, TimeSpan.FromMilliseconds(500)),
                [MirAnimation.Walking] = new Frame(80, 10, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Pushed] = new Frame(80, 10, 10, TimeSpan.FromMilliseconds(50)) { Reversed = true, StaticSpeed = true },
            ...
            FerociousIceTiger = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 6, 10, TimeSpan.FromMilliseconds(500)),
            ...
            SamaFireGuardian = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Walking] = new Frame(80, 8, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Combat1] = new Frame(160, 8, 10, TimeSpan.FromMilliseconds(100)),
            ...
            Phoenix = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Walking] = new Frame(80, 8, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Combat1] = new Frame(160, 8, 10, TimeSpan.FromMilliseconds(100)),
            ...
            EnshrinementBox = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            BloodStone = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            SamaCursedBladesman = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            SamaCursedSlave = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Combat1] = new Frame(160, 8, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Struck] = new Frame(240, 3, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Die] = new Frame(320, 7, 10, TimeSpan.FromMilliseconds(100)),
            ...
            SamaProphet = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            SamaSorcerer = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Combat1] = new Frame(160, 9, 10, TimeSpan.FromMilliseconds(100)),
            ...
            EasterEvent = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Die] = new Frame(320, 6, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Dead] = new Frame(325, 1, 10, TimeSpan.FromMilliseconds(500)),
            ...
            OrangeTiger = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Walking] = new Frame(80, 8, 10, TimeSpan.FromMilliseconds(100)),
            ...
            RedTiger = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Walking] = new Frame(80, 8, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Pushed] = new Frame(80, 8, 10, TimeSpan.FromMilliseconds(50)) { Reversed = true, StaticSpeed = true },
                [MirAnimation.Die] = new Frame(320, 6, 10, TimeSpan.FromMilliseconds(100)),
            ...
            OrangeBossTiger = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            BigBossTiger = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 6, 0, TimeSpan.FromMilliseconds(500)),
            ...
            SDMob3 = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            SDMob8 = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Combat2] = new Frame(480, 6, 10, TimeSpan.FromMilliseconds(100)),
};

            SDMob15 = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            SDMob16 = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            SDMob17 = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            SDMob18 = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            SDMob19 = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 6, 10, TimeSpan.FromMilliseconds(500)),
            ...
            SDMob21 = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 6, 10, TimeSpan.FromMilliseconds(500)),
            ...
            SDMob22 = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 6, 10, TimeSpan.FromMilliseconds(500)),
            ...
            SDMob23 = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 10, 10, TimeSpan.FromMilliseconds(500)),
            ...
            SDMob24 = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 7, 10, TimeSpan.FromMilliseconds(500)),
            ...
            SDMob25 = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 7, 10, TimeSpan.FromMilliseconds(500)),
            ...
            SDMob26 = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 7, 10, TimeSpan.FromMilliseconds(500)),
            ...
            LobsterLord = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            JinamStoneGate = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 1, 0, TimeSpan.FromMilliseconds(200)),
};


            DeadTree = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 1, 0, TimeSpan.FromMilliseconds(200)),
                [MirAnimation.Struck] = new Frame(0, 1, 0, TimeSpan.FromMilliseconds(200)),
            ...
            MonasteryMon1 = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            MonasteryMon3 = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 15, 20, TimeSpan.FromMilliseconds(500)),
                [MirAnimation.Walking] = new Frame(160, 7, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Pushed] = new Frame(160, 7, 10, TimeSpan.FromMilliseconds(50)) { Reversed = true, StaticSpeed = true },
            ...
            Terracotta1 = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            Terracotta2 = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(160, 4, 10, TimeSpan.FromMilliseconds(500)),
                [MirAnimation.Walking] = new Frame(240, 6, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Combat1] = new Frame(320, 8, 10, TimeSpan.FromMilliseconds(100)),
            ...
            Terracotta3 = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(160, 4, 10, TimeSpan.FromMilliseconds(500)),
                [MirAnimation.Walking] = new Frame(240, 6, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Combat1] = new Frame(320, 8, 10, TimeSpan.FromMilliseconds(100)),
            ...
            TerracottaSub = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(160, 4, 10, TimeSpan.FromMilliseconds(500)),
                [MirAnimation.Walking] = new Frame(240, 6, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Combat1] = new Frame(320, 8, 10, TimeSpan.FromMilliseconds(100)),
            ...
            TerracottaBoss = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Combat1] = new Frame(240, 9, 10, TimeSpan.FromMilliseconds(100)),
            ...
            BobbitWorm = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            Tornado = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            InfernalSoldier = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 4, 10, TimeSpan.FromMilliseconds(500)),
                [MirAnimation.Walking] = new Frame(80, 6, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Pushed] = new Frame(80, 6, 10, TimeSpan.FromMilliseconds(50)) { Reversed = true, StaticSpeed = true },
            ...
            SeaHorseCavalry = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            Seamancer = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 6, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Walking] = new Frame(80, 6, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Pushed] = new Frame(80, 6, 10, TimeSpan.FromMilliseconds(50)) { Reversed = true, StaticSpeed = true },
            ...
            CoralStoneDuin = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 6, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Walking] = new Frame(80, 8, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Pushed] = new Frame(80, 8, 10, TimeSpan.FromMilliseconds(50)) { Reversed = true, StaticSpeed = true },
            ...
            Brachiopod = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 6, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Walking] = new Frame(80, 6, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Pushed] = new Frame(80, 6, 10, TimeSpan.FromMilliseconds(50)) { Reversed = true, StaticSpeed = true },
            ...
            GiantClam = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            BlueMassif = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 6, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Walking] = new Frame(80, 6, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Pushed] = new Frame(80, 6, 10, TimeSpan.FromMilliseconds(50)) { Reversed = true, StaticSpeed = true },
            ...
            Mollusk = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 6, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Walking] = new Frame(80, 6, 10, TimeSpan.FromMilliseconds(100)),
                [MirAnimation.Pushed] = new Frame(80, 6, 10, TimeSpan.FromMilliseconds(50)) { Reversed = true, StaticSpeed = true },
            ...
            GiantClam1 = new std::unordered_map<MirAnimation, Frame>
            {
                [MirAnimation.Standing] = new Frame(0, 8, 10, TimeSpan.FromMilliseconds(100)),
                //Walking?
                //Pushed?
            ...
            CastleFlag = new std::unordered_map<MirAnimation, Frame>
            {
            ...
            SabukGate = new std::unordered_map<MirAnimation, Frame>
            {
    ...
    class Frame
    {
        ...
        public Frame(int32_t startIndex, int32_t frameCount, int32_t offSet, TimeSpan frameDelay)
        {
            ...
            for (int32_t i = 0; i < Delays.Length; i++)
                Delays[i] = frameDelay;
};
        ...
        public int32_t GetFrame(DateTime start, DateTime now, bool doubleSpeed)
        {
