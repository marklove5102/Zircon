...
namespace Library
{
// Enable bitwise operations for flags enums
template<typename T>
...
operator&=(T& lhs, T rhs) {
    ...
    enum class MarketPlaceSort
    {
        ...
        LowestPrice};
    enum class MarketPlaceStoreSort
    {
        Alphabetical,
        // Highest Price
