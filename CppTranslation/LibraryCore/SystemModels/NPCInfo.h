...
namespace Library.SystemModels
{
    class NPCInfo : DBObject
    {
        ...
        DBBindingstd::vector<QuestInfo> StartQuests;

        [JsonIgnore]
        [Association("FinishQuests")]
        DBBindingstd::vector<QuestInfo> FinishQuests;

        [Association("Requirements", true)]
        DBBindingstd::vector<NPCRequirement> Requirements;
    ...
    class CurrentQuest : IEquatable<CurrentQuest>
    {
        QuestType Type;
        QuestIcon Icon;
    ...
    class NPCPage : DBObject
    {
        ...
        DBBindingstd::vector<NPCCheck> Checks;

        [Association("Actions", true)]
        DBBindingstd::vector<NPCAction> Actions;

        [Association("Buttons", true)]
        DBBindingstd::vector<NPCButton> Buttons;

        [Association("Goods", true)]
        DBBindingstd::vector<NPCGood> Goods;

        [Association("Types", true)]
        DBBindingstd::vector<NPCType> Types;

        [Association("Values", true)]
        DBBindingstd::vector<NPCValue> Values;
};

    class NPCGood : DBObject
    {
        [Association("Goods")]
        public NPCPage Page
        {
        ...
        [JsonIgnore]
        [IgnoreProperty]
        public int32_t Cost => (int32_t)Math.Round(Item.Price * Rate);
};

    class NPCType : DBObject
    {
        [Association("Types")]
        public NPCPage Page
        {
    ...
    class NPCCheck : DBObject
    {
        ...
        private int32_t _IntParameter2;
    ...
    class NPCValue : DBObject
    {
        ...
        public std::string DataCategory
        {
        ...
        private std::string _DataCategory;
