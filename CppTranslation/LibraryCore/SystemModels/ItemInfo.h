...
{
    class ItemInfo : DBObject
    {
        [IsIdentity]
        public std::string ItemName
        {
        ...
        private int32_t _RequiredAmount;
        ...
        private int32_t _BuffIcon;

        public int32_t PartCount
        {
        ...
        DBBindingstd::vector<ItemInfoStat> ItemStats;
        ...
        public override std::string ToString()
        {
            return ItemName;
};
};
