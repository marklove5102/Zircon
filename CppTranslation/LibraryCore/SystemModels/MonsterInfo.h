...
{
    class MonsterInfo : DBObject
    {
        [IsIdentity]
        public std::string MonsterName
        {
        ...
        private std::string _MonsterName;
        ...
        private int32_t _ViewRange;

        public int32_t CoolEye
        {
            get { return _CoolEye; }
            set
            {
        ...
        private int32_t _AttackDelay;

        public int32_t MoveDelay
        {
        ...
        DBBindingstd::vector<MonsterInfoStat> MonsterInfoStats;

        [JsonIgnore]
        [Association("Respawns", true)]
        DBBindingstd::vector<RespawnInfo> Respawns;

        [JsonIgnore]
        [Association("Drops", true)]
        DBBindingstd::vector<DropInfo> Drops;

        [JsonIgnore]
        [Association("Events", true)]
        DBBindingstd::vector<MonsterEventTrigger> Events;

        [JsonIgnore]
        [Association("QuestDetails", true)]
        DBBindingstd::vector<QuestTaskMonsterDetails> QuestDetails;
