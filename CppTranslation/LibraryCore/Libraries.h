...
namespace Library
{
    ...
    {
        public static std::unordered_map<LibraryFile, std::string> LibraryList = new std::unordered_map<LibraryFile, std::string>
        {
        ...
        public static std::unordered_map<int32_t, LibraryFile> KROrder = new std::unordered_map<int32_t, LibraryFile>
        {
